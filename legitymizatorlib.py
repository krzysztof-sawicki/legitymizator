...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.1 on Mon Nov  3 21:33:59 2025
#
...
class ScannerSelection(wx.Frame):
	def __init__(self, *args, **kwds):
		# begin wxGlade: ScannerSelection.__init__
		kwds["style"] = kwds.get("style", 0) | wx.DEFAULT_FRAME_STYLE
		wx.Frame.__init__(self, *args, **kwds)
		self.SetSize((400, 300))
		self.SetTitle(u"Wybór skanera")

		self.panel_1 = wx.Panel(self, wx.ID_ANY)

		self.sizer_1 = wx.BoxSizer(wx.VERTICAL)

		label_1 = wx.StaticText(self.panel_1, wx.ID_ANY, "Wybierz skaner:")
		self.sizer_1.Add(label_1, 1, 0, 0)

		sizer_2 = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_1.Add(sizer_2, 2, wx.EXPAND, 0)

		self.scannerOKbutton = wx.Button(self.panel_1, wx.ID_ANY, "OK")
		sizer_2.Add(self.scannerOKbutton, 1, wx.ALIGN_CENTER_VERTICAL, 0)

		self.scannerCancelButton = wx.Button(self.panel_1, wx.ID_ANY, "Anuluj")
		sizer_2.Add(self.scannerCancelButton, 1, wx.ALIGN_CENTER_VERTICAL, 0)

		self.findScannersButton = wx.Button(self.panel_1, wx.ID_ANY, u"Znajdź skanery")
		sizer_2.Add(self.findScannersButton, 1, wx.ALIGN_CENTER_VERTICAL, 0)

		self.panel_1.SetSizer(self.sizer_1)

		self.Layout()

		self.scannerOKbutton.Bind(wx.EVT_BUTTON, self.onOKButton)
		self.scannerCancelButton.Bind(wx.EVT_BUTTON, self.onCancelButton)
		self.findScannersButton.Bind(wx.EVT_BUTTON, self.onFindScanners)
		# end wxGlade

	def onOKButton(self, event):  # wxGlade: ScannerSelection.<event_handler>
		print("Event handler 'onOKButton' not implemented!")
		event.Skip()

	def onCancelButton(self, event):  # wxGlade: ScannerSelection.<event_handler>
		print("Event handler 'onCancelButton' not implemented!")
		event.Skip()

	def onFindScanners(self, event):  # wxGlade: ScannerSelection.<event_handler>
		print("Event handler 'onFindScanners' not implemented!")
		event.Skip()

# end of class ScannerSelection
...
class Legitymizator(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.SetFont(wx.Font(12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, "Ubuntu"))
		...
		item = wxglade_tmp_menu.Append(wx.ID_ANY, u"&Eksport zdjęć", "")
		self.Bind(wx.EVT_MENU, self.onPhotoExport, item)
		item = wxglade_tmp_menu.Append(wx.ID_ANY, u"O&ptymalizuj bazę", "")
		self.Bind(wx.EVT_MENU, self.onDbOptimize, item)
		self.frame_menubar.Append(wxglade_tmp_menu, "&Plik")
		wxglade_tmp_menu = wx.Menu()
		item = wxglade_tmp_menu.Append(wx.ID_ANY, "Wybierz &skaner", "")
		self.Bind(wx.EVT_MENU, self.onScannerSelection, item)
		self.frame_menubar.Append(wxglade_tmp_menu, "Konfiguracja programu")
		...
		# statusbar fields
		statusbar_fields = ["Legitymizator v0.1"]
		for i in range(len(statusbar_fields)):
			self.statusbar.SetStatusText(statusbar_fields[i], i)

		self.mainPanel = wx.Panel(self, wx.ID_ANY)
		self.mainPanel.SetFont(wx.Font(12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, "Ubuntu"))
		...
		self.documentListCtrl.SetFont(wx.Font(12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, "Ubuntu"))
		...
		self.documentListCtrl.AppendColumn("Blankiet", format=wx.LIST_FORMAT_LEFT, width=150)
		...
		grid_sizer_1 = wx.FlexGridSizer(10, 2, 2, 2)
		...
		label_11 = wx.StaticText(self.mainPanel, wx.ID_ANY, "Numer blankietu")
		grid_sizer_1.Add(label_11, 0, 0, 0)

		self.fCardNumber = wx.TextCtrl(self.mainPanel, wx.ID_ANY, "")
		self.fCardNumber.SetMinSize((300, 30))
		grid_sizer_1.Add(self.fCardNumber, 0, wx.ALIGN_CENTER, 0)
		...
		self.RecordChangeIndicator.SetFont(wx.Font(12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
		...
		self.scanPhotoButton = wx.Button(self.mainPanel, wx.ID_ANY, u"Skanuj zdjęcie")
		sizer_8.Add(self.scanPhotoButton, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
		...
		self.documentListCtrl.Bind(wx.EVT_LIST_ITEM_RIGHT_CLICK, self.onDocumentListCtrlRightClick)
		self.documentListCtrl.Bind(wx.EVT_LIST_ITEM_SELECTED, self.onDocumentListCtrlSelect)
		self.fStudentName.Bind(wx.EVT_TEXT, self.onFStudentNameEnter)
		self.fPESEL.Bind(wx.EVT_TEXT, self.onfPESELEnter)
		self.fBirthDate.Bind(wx.adv.EVT_CALENDAR_SEL_CHANGED, self.onFBirthDateChange)
		self.fSchool.Bind(wx.EVT_TEXT, self.onFSchoolEnter)
		self.fPrincipal.Bind(wx.EVT_TEXT, self.onFPrincipalEnter)
		self.fIssueDate.Bind(wx.adv.EVT_CALENDAR_SEL_CHANGED, self.onFIssueDateChange)
		self.fIdNumber.Bind(wx.EVT_TEXT, self.onFIdNumberEnter)
		self.fCardNumber.Bind(wx.EVT_TEXT, self.onFCardNumberEnter)
		self.GenerateFileButton.Bind(wx.EVT_BUTTON, self.onGenerateFileButton)
		self.PrintButton.Bind(wx.EVT_BUTTON, self.onPrintButton)
		self.SaveRecordButton.Bind(wx.EVT_BUTTON, self.onSaveRecordButton)
		self.NewRecordButton.Bind(wx.EVT_BUTTON, self.onNewRecordButton)
		...
		self.photo.Bind(wx.EVT_MOUSEWHEEL, self.photoMouseWheel)
		self.loadFileButton.Bind(wx.EVT_BUTTON, self.openPhotoFileSelector)
		self.scanPhotoButton.Bind(wx.EVT_BUTTON, self.scanAndLoadPhoto)
		self.viewGenerateButton.Bind(wx.EVT_BUTTON, self.onViewGenerateButton)
	...
	def onPhotoExport(self, event):  # wxGlade: Legitymizator.<event_handler>
		print("Event handler 'onPhotoExport' not implemented!")
		event.Skip()

	def onDbOptimize(self, event):  # wxGlade: Legitymizator.<event_handler>
		print("Event handler 'onDbOptimize' not implemented!")
		event.Skip()

	def onScannerSelection(self, event):  # wxGlade: Legitymizator.<event_handler>
		print("Event handler 'onScannerSelection' not implemented!")
		event.Skip()
	...
	def onDocumentListCtrlRightClick(self, event):  # wxGlade: Legitymizator.<event_handler>
		print("Event handler 'onDocumentListCtrlRightClick' not implemented!")
		event.Skip()
	...
	def onFCardNumberEnter(self, event):  # wxGlade: Legitymizator.<event_handler>
		print("Event handler 'onFCardNumberEnter' not implemented!")
		event.Skip()
	...
	def scanAndLoadPhoto(self, event):  # wxGlade: Legitymizator.<event_handler>
		print("Event handler 'scanAndLoadPhoto' not implemented!")
		event.Skip()
...
class DBSettings(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.settingsSaveButton.Bind(wx.EVT_BUTTON, self.onSettingsSaveButton)
		# end wxGlade
